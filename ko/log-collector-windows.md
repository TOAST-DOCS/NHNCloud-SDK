...
## NHN Cloud > SDK 사용 가이드 > Log & Crash > Windows C++ { #nhn-cloud-sdk-user-guide-log-crash-windows-c }
...
## 사용자 정의 필드 추가 { #add-user-defined-fields }

<a id="method-1-use-the-nhncloudlogger-instance-api"></a>
### 방법 1 : NHNCloudLogger 인스턴스 API 사용 { #method-1-use-the-nhncloudlogger-instance-api }
...
### 방법 2 : NHNCloudLoggerUserFields 클래스 사용 { #method-2-use-the-nhncloudloggeruserfields-class }
...
### 크래시 로그 수집과 환경 설정 { #crash-log-collection-and-configuration }
...
### 크래시 로그 전송 테스트 { #test-sending-crash-logs }
...
### 크래시 로그 해석 { #interpret-crash-logs }
